...
- business home analytics (`AnalyticsHeroSection`) with custom date filtering and external market/weather insights proxied by backend (`/api/market/rates`, `/api/weather/forecast`). See [BUSINESS_DASHBOARD.md](./BUSINESS_DASHBOARD.md).
