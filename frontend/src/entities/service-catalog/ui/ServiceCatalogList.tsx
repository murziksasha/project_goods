...
export interface ServiceCatalogListProps {
...
export const ServiceCatalogList: React.FC<
  ServiceCatalogListProps
> = ({ services, isLoading, searchQuery, onEdit, onDelete }) => {
  const { t } = useTranslation();

  if (isLoading) {
    return (
      <p className='empty-state'>{t('legacy.serviceList.loading')}</p>
    );
  }
