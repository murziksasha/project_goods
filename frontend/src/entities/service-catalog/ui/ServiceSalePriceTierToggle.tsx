...
} from '../../../shared/ui/SalePriceTierToggle';

export interface ServiceSalePriceTierToggleProps {
...
export const ServiceSalePriceTierToggle: React.FC<
  ServiceSalePriceTierToggleProps
> = ({ service, activeTier, onTierChange, disabled = false }) => {
  const { t } = useTranslation();

  const options = useMemo<
    Array<SalePriceTierOption<ServiceSalePriceTier>>
  >(
    () =>
