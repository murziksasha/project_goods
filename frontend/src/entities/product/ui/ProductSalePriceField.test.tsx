...
describe('ProductSalePriceField', () => {
  it('shows retail/wholesale tier badges only when wholesale price is configured', () => {
    ...
    expect(
      screen.queryByRole('button', { name: 'Wholesale' }),
    ).not.toBeInTheDocument();
  });
  ...
  it('renders tier badges in the field label row when tierTogglePlacement is label', () => {
    ...
    const labelRow = container.querySelector(
      '.product-sale-price-field-label',
    );
    expect(labelRow).toBeTruthy();
    expect(
      labelRow?.querySelector('.product-sale-price-tier-toggle'),
    ).toBeTruthy();
    expect(
      container.querySelector(
        '.product-sale-price-field .product-sale-price-tier-toggle',
      ),
    ).toBeNull();
  });
  ...
  it('renders only the stepper when tierTogglePlacement is none', () => {
    ...
    expect(
      container.querySelector('.product-sale-price-tier-toggle'),
    ).toBeNull();
    expect(
      container.querySelector('.product-sale-price-field-compact'),
    ).toBeNull();
  });
  ...
  it('renders tier badges above the stepper when tierTogglePlacement is compact', () => {
    ...
    expect(
      compactLabel?.querySelector('.product-sale-price-tier-toggle'),
    ).toBeTruthy();
    expect(
      container.querySelector(
        '.product-sale-price-field .product-sale-price-tier-toggle',
