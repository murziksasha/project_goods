...
en.clients = JSON.parse(fs.readFileSync('scripts/clients-locale-en.json', 'utf8'));
uk.clients = JSON.parse(fs.readFileSync('scripts/clients-locale-uk.json', 'utf8'));

fs.writeFileSync(enPath, `${JSON.stringify(en, null, 2)}\n`);
fs.writeFileSync(ukPath, `${JSON.stringify(uk, null, 2)}\n`);
console.log('Clients locale merged');