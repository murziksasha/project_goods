...
Активная вкладка dashboard синхронизируется с URL-параметром `page`. Это позволяет пользователю обновить страницу через F5 или кнопку браузера и остаться в текущем разделе, например `?page=orders`.
